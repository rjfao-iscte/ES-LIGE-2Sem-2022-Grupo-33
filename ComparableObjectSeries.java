...
public class ComparableObjectSeries<K extends Comparable<K>> extends Series<K>
    ...
    public void setMaximumItemCount(int maximum) {
        ...
        boolean dataRemoved = dataRemoved(maximum);
	...
	private boolean dataRemoved(int maximum) {
	...
	private int index(ComparableObjectItem item, int index) throws SeriesException {
		if (this.allowDuplicateXValues) {
